CREATE DATABASE Group_By_Continue -- Yaranan db-ya kecid edin.
...
--SELECT
--    Ishci.Id AS IshciId,
--    COUNT(Satish.Id) AS SatilanMehsulSayi
--FROM
--    Ishci
--LEFT JOIN Satish ON Ishci.Id = Satish.IshciId
--GROUP BY
--    Ishci.Id;
...
--    Satish
--WHERE
--    CONVERT(DATE, Satish_Tarixi) = CONVERT(DATE, GETDATE())
--GROUP BY
--    FilialId
--ORDER BY
--    COUNT(Satish.Id) DESC;
...
--    SELECT
--        MehsulId,
--        COUNT(Id) AS SatilanMehsulSayi
--    FROM
--        Satish
--    WHERE
--        YEAR(Satish_Tarixi) = YEAR(GETDATE())
